...
public class AudioFrameBytePacket extends RtpPacket {
    ...
    public static AudioFrameBytePacket getCloneFrame(AudioFrameBytePacket frame) {
        AudioFrameBytePacket cloneFrame = getNewFrame(frame.len);
        System.arraycopy(frame.data, 0, cloneFrame, 0, frame.len);
        return cloneFrame;
    }
